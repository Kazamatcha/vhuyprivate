...
--// Settings
local ESP_SETTINGS = {
    BoxOutlineColor = Color3.new(0, 0, 0), -- outline giữ nguyên
    BoxColor = Color3.fromRGB(255, 170, 220), -- hồng nhạt

    NameColor = Color3.fromRGB(255, 170, 220), -- hồng nhạt

    HealthOutlineColor = Color3.new(0, 0, 0), -- outline giữ nguyên

    HealthHighColor = Color3.fromRGB(255, 170, 220), -- hồng nhạt
    HealthLowColor = Color3.fromRGB(255, 100, 150), -- hồng hơi đậm khi low HP
    ...
    ShowDistance = true,
    ShowSkeletons = true,
    SkeletonsColor = Color3.fromRGB(255, 170, 220), -- hồng
    ShowTracer = true,
    TracerColor = Color3.fromRGB(255, 170, 220), -- hồng
    TracerThickness = 2,
